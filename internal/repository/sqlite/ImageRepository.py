...
from pkg.store.sql import SessionLocal  # Import SessionLocal if needed for testing
from internal.repository.models.users import Image  # Adjust path if needed
